"""
Get implied volatilities from a Leisen-Reimer binomial three using the bisection
method as the numerical procedure
"""
import sys
path1="E:\python_study\Mastering_Python_for_finance\chapter_3"
path2="E:\python_study\Mastering_Python_for_finance\chapter_4"
...
class ImpliedVolatilityModel(object):
    ...
    def _option_valuation_(self,K,sigma):
        ...
        lr_option=BinomialLROption(self.S0,K,self.r,self.T,self.N,
                                   {"sigma":sigma,"is_call":self.is_call,
                                    "div":self.div})
    ...
    def get_implied_volatilities(self,Ks,option_prices):
        ...
        for i in range(len(Ks)):
            ...
            f=lambda sigma:self._option_valuation_(Ks[i],sigma)-option_prices[i]
